...
const getVideos = (0, async_middleware_1.asyncAwaitHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let [videos, totalVidoes] = yield Promise.all([
    ...
    videos = videos.map((video) => (Object.assign(Object.assign({}, video), { thumbnailUrl: (0, s3_1.getFileCloudFront)({ fileName: video.thumbnailUrl || "" }) })));
    res.status(200).json({
        success: true,
        data: {
            videos,
...
const getVideo = (0, async_middleware_1.asyncAwaitHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    video.thumbnailUrl = (0, s3_1.getFileCloudFront)({ fileName: video.thumbnailUrl || "" });
    res.status(200).json({
        success: true,
        data: {
            video,
